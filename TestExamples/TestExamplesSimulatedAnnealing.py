...
class TestExamplesSimulatedAnnealing(unittest.TestCase):
    def setUp(self):
        '''
    ...
    def test_LinearDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], 5.00000036802, guess_tol)
        self.assertAlmostEqual(guess[1], 2.99999991654, guess_tol)
    ...
    def test_QuadraticDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], 1.9999988948, guess_tol)
        self.assertAlmostEqual(guess[1], -4.99999951053, guess_tol)
        self.assertAlmostEqual(guess[2], 0.999999959319, guess_tol)
