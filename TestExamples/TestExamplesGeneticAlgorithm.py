...
class TestExamplesGeneticAlgorithm(unittest.TestCase):
    def setUp(self):
        '''
    ...
    def test_LinearDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], 4.04730379757, guess_tol)
        self.assertAlmostEqual(guess[1], 3.18463511586, guess_tol)
...
if __name__ == '__main__':
    ...
    test_list = [TestExamplesGeneticAlgorithm]
