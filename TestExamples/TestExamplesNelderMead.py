...
class TestExamplesNelderMead(unittest.TestCase):
    def setUp(self):
        '''
    ...
    def test_LinearDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], 4.99999974182, guess_tol)
        self.assertAlmostEqual(guess[1], 3.00000001726, guess_tol)
    ...
    def test_ExponentialDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], 0.999996232032, guess_tol)
        self.assertAlmostEqual(guess[1], 0.500017468532, guess_tol)
...
if __name__ == '__main__':
    ...
    test_list = [TestExamplesNelderMead]
