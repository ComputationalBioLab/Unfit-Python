...
class TestExamplesParticleSwarm(unittest.TestCase):
    def setUp(self):
        '''
        ...
        self.ps = libUnfitPython.ParticleSwarm()
        self.ps.bounds.SetBounds(lower, upper)
    ...
    def test_LinearDirectInput(self):
        ...
        self.ps.FindMin(cf, guess)
        
        self.assertAlmostEqual(guess[0], 4.99999990991, guess_tol)
        self.assertAlmostEqual(guess[1], 3.00000002684, guess_tol)
    ...
    def test_QuadraticDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], -0.0779275716518, guess_tol)
        self.assertAlmostEqual(guess[1], -4.21134947663, guess_tol)
        self.assertAlmostEqual(guess[2], 0.937407004756, guess_tol)
    ...
    def test_ExponentialDirectInput(self):
        ...
        self.assertAlmostEqual(guess[0], 0.999996809131, guess_tol)
        self.assertAlmostEqual(guess[1], 0.500017594239, guess_tol)
...
if __name__ == '__main__':
    ...
    test_list = [TestExamplesParticleSwarm]
